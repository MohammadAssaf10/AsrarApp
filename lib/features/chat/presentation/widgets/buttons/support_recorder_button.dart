...
class SupportRecorderButton extends StatefulWidget {
  const SupportRecorderButton({
    Key? key,
  ...
  @override
  State<SupportRecorderButton> createState() => _RecorderButtonState();
}

class _RecorderButtonState extends State<SupportRecorderButton> {
